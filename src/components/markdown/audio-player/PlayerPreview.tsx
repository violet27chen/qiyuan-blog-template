      ...
      fetch(lrcSource)
        ...
        .then((t) => {
          ...
          try {
            ...
            if (parsed.data && typeof parsed.data.lyric === 'string') {
              setText(parsed.data.lyric);
              return;
            }
          } catch {}
          setText(t);
    ...
    <div className="audio-player-preview">
      ...
      <div className="audio-player-disc-wrapper">
        <div className={cn('audio-player-disc', playing && 'spinning')}>
          {track?.pic ? (
            <img src={track.pic} alt={track.name || ''} className="audio-player-cover" referrerPolicy="no-referrer" draggable={false} />
          ) : (
