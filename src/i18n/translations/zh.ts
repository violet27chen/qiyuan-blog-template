...
export const uiStrings = {
  ...
  // ── Drive (网盘) ──────────────────────────────────────────
  'drive.uploadTitle': '上传文件（公开分享，单文件最大 500MB）',
  'drive.pageDesc': '公开文件分享：上传即生成直链，文件存于 R2，国内经 EdgeOne 加速读取。',
  'drive.verifyFirst': '请先完成人机验证',
  'drive.uploading': '上传中 {pct}%',
  'drive.uploadingBtn': '上传中…',
  'drive.uploadBtn': '上传并生成分享链接',
  'drive.sharedFiles': '已分享文件',
  'drive.refresh': '刷新',
  'drive.empty': '还没有文件',
  'drive.autoExpire': '文件上传后 24 小时自动删除，请及时下载',
  'drive.download': '下载',
  'drive.preview': '预览',
  'drive.errorInit': '获取上传地址失败',
  'drive.errorConfirm': '上传确认失败',
  'drive.errorUpload': '上传失败',
  'drive.errorNet': '上传网络错误（可能是直连 Cloudflare 主机被干扰，请重试）',

  // ── Shorten (短链) ──────────────────────────────────────
  'nav.shorten': '短链',
  'shorten.pageDesc': '把长链接生成短链接：输入网址即可获得 qiyuan.icu/api/s/ 短地址，永久有效。',
  'shorten.urlPlaceholder': '粘贴要缩短的链接（https://…）',
  'shorten.slugPlaceholder': '可选：自定义短码（字母数字 _ -，3-32 位）',
  'shorten.generate': '生成短链',
  'shorten.generating': '生成中…',
  'shorten.urlRequired': '请输入要缩短的链接',
  'shorten.errorGeneric': '生成失败，请重试',
  'shorten.copied': '已复制',
  ...
  'search.modeKeyword': '关键词',
  'search.modeSemantic': '语义',
  'search.semanticPlaceholder': '用自然语言描述你想找的内容，如「怎么在大陆稳定用 ChatGPT」',
  'search.semanticEmpty': '没有找到语义相关的文章',
  ...
  // ── Chat ────────────────────────────────────────────────
  'chat.askArticle': '就这篇文章问 AI',
  'chat.scopedPrefix': '正在讨论：',
  'chat.exitScope': '退出文章范围',
  ...
  'comment.loading': '加载中…',
  'comment.empty': '还没有评论，来抢沙发～',
  'comment.anonymous': '匿名',
  'comment.placeholder': '写下你的评论…（可粘贴图片上传）',
  'comment.image': '图片',
  'comment.uploading': '上传中…',
  'comment.submit': '发表评论',
  'comment.posting': '发表中…',
  'comment.emptyContent': '评论内容不能为空',
  'comment.uploadFailed': '图片上传失败',
  'comment.submitFailed': '评论提交失败',
  'comment.poweredBy': '由 Cloudflare KV + R2 驱动',
  ...
  // ── Resources ──────────────────────────────────────────────
  'resources.title': '资源站',
  'resources.description': '精选软件、AI 工具与学习资料，支持夸克等多网盘免费获取',
  'resources.intro': '本站资源来自网盘分享，点击即可跳转获取链接。',
  'resources.searchPlaceholder': '搜索资源名称、描述或分类…',
  'resources.clearFilters': '清空筛选',
  'resources.allCategories': '全部',
  'resources.resultCount': '共 {count} 个资源',
  'resources.download': '免费获取',
  'resources.empty': '没有找到匹配的资源',
  'resources.loading': '加载中…',
  'resources.error': '资源加载失败，请稍后重试',
  'resources.retry': '重试',

  // ── Resource Card ───────────────────────────────────────────
  'resources.noCover': '暂无封面',
  'resources.uncategorized': '未分类',

  // ── Christmas Toggle ────────────────────────────────────────
  'christmas.pullDownOff': '下拉关闭',
  'christmas.pullDownOn': '下拉开启',
  'christmas.turnOff': '关闭圣诞模式',
  'christmas.turnOn': '开启圣诞模式',
  ...
  // ── Quiz Option ─────────────────────────────────────────────
  'quiz.optionLabel': '选项 {letter}',

  // ── Temp Mail ──────────────────────────────────────────────
  'tempMail.title': '临时邮箱',
  'tempMail.domain': '域名',
  'tempMail.description': '免费临时邮箱，用于注册验证码等一次性场景。地址 24 小时后自动销毁。',
  'tempMail.notConfigured': '临时邮箱尚未配置域名，请在站点后台完成设置。',
  'tempMail.intro': '点击下方按钮生成一个随机临时地址，用于接收注册验证码等一次性邮件。地址 24 小时后自动销毁。',
  'tempMail.generate': '生成临时邮箱地址',
  'tempMail.generating': '生成中…',
  'tempMail.copy': '复制',
  'tempMail.copied': '已复制',
  'tempMail.regenerate': '重新生成',
  'tempMail.inbox': '收件箱',
  'tempMail.content': '邮件内容',
  'tempMail.selectToView': '选择左侧邮件查看内容',
  'tempMail.empty': '暂无邮件，等待接收…',
  'tempMail.from': '发件人',
  'tempMail.subject': '主题',
  'tempMail.noSubject': '(无主题)',
  'tempMail.refresh': '刷新',
  'tempMail.autoRefresh': '自动刷新',
  'tempMail.autoRefreshOn': '自动刷新：开',
  'tempMail.autoRefreshOff': '自动刷新：关',
  'tempMail.lastChecked': '上次检查：{time}',
  'tempMail.verifyWait': '正在进行人机验证，请稍候片刻再试…',
  'tempMail.expiresHint': '提示：部分网站（尤其国内平台、金融类）会屏蔽临时邮箱域名；此服务仅供一次性验证码等合规用途，请勿用于滥用。',
} as const;
